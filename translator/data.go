...
var specialCombinations = map[string]string{
	...
	"ꦮ꦳꧀ꦂ":    "ver",   // ver (for universitas)
	"ꦂ꧀ꦱꦶ":    "rsi",   // rsi (for universitas)
	"ꦤꦶ":      "ni",    // ni
	"ꦮ꦳꧀ꦂ꧀ꦱꦶ": "versi", // versi complete combination
}
...
// Consonant maps consonants to their corresponding Javanese script
